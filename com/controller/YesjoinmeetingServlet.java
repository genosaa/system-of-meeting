...
@WebServlet(name = "YesjoinmeetingServlet" , urlPatterns = "/yesjoinmeeting")
public class YesjoinmeetingServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(meetingdao.yesjoinmeeting(informid,username,meetname)){
